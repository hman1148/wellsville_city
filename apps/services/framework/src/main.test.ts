...
describe('ServicesFramework', () => {
  ...
  it('synthesizes', () => {
    const stack = new AppStack(app, 'ServicesFrameworkTestStack', {
      env: {
        region: 'us-west-2',
  ...
  describe('Sandbox Support', () => {
    ...
    it('synthesizes with sandbox context', () => {
      const stack = new AppStack(sandboxApp, 'ServicesFrameworkSandboxTest', {
        env: {
          region: 'us-west-2',
          account: '123456789012',
        },
    ...
    it('works without sandbox (uses base configuration)', () => {
      ...
      const stack = new AppStack(baseApp, 'ServicesFrameworkBaseTest', {
        env: {
          region: 'us-west-2',
          account: '123456789012',
        },
