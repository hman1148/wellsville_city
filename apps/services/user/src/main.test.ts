...
describe('ServicesUser', () => {
  ...
  it('synthesizes', () => {
    const stack = new AppStack(app, 'ServicesUserTestStack', {
      env: {
        region: 'us-west-2',
  ...
  describe('Sandbox Support', () => {
    ...
    it('synthesizes with sandbox context', () => {
      const stack = new AppStack(sandboxApp, 'ServicesUserSandboxTest', {
        env: {
          region: 'us-west-2',
          account: '123456789012',
        },
    ...
    it('works without sandbox (uses base configuration)', () => {
      ...
      const stack = new AppStack(baseApp, 'ServicesUserBaseTest', {
        env: {
          region: 'us-west-2',
          account: '123456789012',
        },
