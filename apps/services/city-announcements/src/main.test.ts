...
describe('ServicesCityAnnouncements', () => {
	let app: cdk.App;
	...
	it('synthesizes', () => {
		const stack = new AppStack(app, 'ServicesCityAnnouncementsTestStack', {
			env: {
				region: 'us-west-2',
	...
	describe('Sandbox Support', () => {
		...
		it('synthesizes with sandbox context', () => {
			const stack = new AppStack(sandboxApp, 'ServicesCityAnnouncementsSandboxTest', {
				env: {
					region: 'us-west-2',
					account: '123456789012',
				},
		...
		it('works without sandbox (uses base configuration)', () => {
			...
			const stack = new AppStack(baseApp, 'ServicesCityAnnouncementsBaseTest', {
				env: {
					region: 'us-west-2',
					account: '123456789012',
				},
